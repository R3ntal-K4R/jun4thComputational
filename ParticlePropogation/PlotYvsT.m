...
y    = data(:, 4);  % The 'x' position data is in the 3rd column
...
plot(time, y, 'o-', 'LineWidth', 2, 'MarkerSize', 8, 'MarkerFaceColor', [0, 0.4, 0.7]);

% --- Formatting the Plot ---
% Add a title and labels to the axes.
title('Particle Trajectory: Time vs. Y-coordinate');
xlabel('Time (s)');
ylabel('Y-coordinate');
...
legend('y-position', 'Location', 'northeast');
